...
export class ListComponent {
  ...
  */
  ...
  deleteData(id:any) {    
    if(id){
      this.ProductService.deleteTicket(id).subscribe({
        next: data => { },
        error: err => {
  ...
  */
  saveUser() {
    if (this.ordersForm.valid) {
      if (this.ordersForm.get('ids')?.value) {
        this.ProductService.patchTicketData(this.ordersForm.value).subscribe(
          (data: any) => {
        ...
        this.ProductService.postTicketData(this.ordersForm.value).subscribe(
          (data: any) => {          
  ...
  editDataGet(id: any, content:any) {
    ...
    this.ProductService.getSingTicketData(id).subscribe({
      next: data => {    
