...
export class OrdersComponent {
  ...
  constructor(private modalService: NgbModal,public service: OrdersService, private formBuilder: UntypedFormBuilder, private ProductService : ProductService, private datePipe: DatePipe) {
  ...
  */  
  saveUser() {
    if (this.ordersForm.valid) {
      if (this.ordersForm.get('ids')?.value) {
        this.ProductService.patchOrderData(this.ordersForm.value).subscribe(
          (data: any) => {
        ...
        this.ProductService.postOrderData(this.ordersForm.value).subscribe(
          (data: any) => {
   ...
   */
   editDataGet(id: any, content:any) {
    ...
    this.ProductService.getSingleOrderData(id).subscribe({
      next: data => {    
