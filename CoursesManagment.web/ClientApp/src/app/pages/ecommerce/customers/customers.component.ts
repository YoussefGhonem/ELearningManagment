...
export class CustomersComponent {
  ...
  constructor(private modalService: NgbModal,public service: CustomersService, private formBuilder: UntypedFormBuilder, private ProductService : ProductService, private datePipe: DatePipe) {
  ...
  */
    saveUser() {
      if (this.customerForm.valid) {
        if (this.customerForm.get('ids')?.value) {
          this.ProductService.patchCustomerData(this.customerForm.value).subscribe(
            (data: any) => {
          ...
          this.ProductService.postCustomerData(this.customerForm.value).subscribe(
            (data: any) => {            
   ...
   */
   ...
   editDataGet(id: any, content:any) {
    ...
    this.ProductService.getSingleCustomerData(id).subscribe({
      next: data => {    
