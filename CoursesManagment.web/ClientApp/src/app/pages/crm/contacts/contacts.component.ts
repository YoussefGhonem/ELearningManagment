...
export class ContactsComponent implements OnInit {
  ...
  constructor(private modalService: NgbModal,public service: ContactsService, private formBuilder: UntypedFormBuilder, private ProductService : ProductService, private datePipe: DatePipe) {
  ...
  */
   saveUser() {
     if (this.contactsForm.valid) {  
      if (this.contactsForm.get('ids')?.value) {
        this.ProductService.patchContactData(this.contactsForm.value).subscribe(
          (data: any) => {
        ...
        this.ProductService.postContactData(this.contactsForm.value).subscribe(
          (data: any) => {
   ...
   */
   editDataGet(id: any, content:any) {    
    ...
    this.ProductService.getSingleContactData(id).subscribe({
      next: data => {    
  ...
  */
  ...
  deleteData(id:any) {    
    if(id){
      this.ProductService.deleteContact(id).subscribe({
        next: data => { },
        error: err => {
          this.content = JSON.parse(err.error).message;
        }
