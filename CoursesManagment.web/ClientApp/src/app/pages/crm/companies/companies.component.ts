...
export class CompaniesComponent {
  ...
  constructor(private modalService: NgbModal, public service: CompaniesService, private formBuilder: UntypedFormBuilder, private ProductService : ProductService) {
  ...
  */
   saveUser() {
    if (this.companiesForm.valid) {
      if (this.companiesForm.get('ids')?.value) {
        this.ProductService.patchCompanyData(this.companiesForm.value).subscribe(
          (data: any) => {
        ...
        this.ProductService.postCompanyData(this.companiesForm.value).subscribe(
          (data: any) => {
   ...
   */
   viewDataGet(id: any) {    
    this.ProductService.getSingleCompanyData(id).subscribe({
      next: data => {    
